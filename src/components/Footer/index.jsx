  ...
  return (
    <footer className="bg-primary text-[#eaeaea]">
      ...
      <div className="container">
        {/* MOBILE: Chia 2 cột (grid-cols-2). DESKTOP: Trả về 5 cột như gốc (md:grid-cols-5 md:gap-10) */}
        <div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-10 md:grid-cols-5 md:gap-10">
          ...
          {/* Liên hệ: Mobile chiếm 2 cột để chữ không bị ép chật, Desktop trả về 1 cột */}
          <div className="md:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-[#cfcfcf]">
              <div className="flex items-start gap-2">
                ...
                {/* Cho phép rớt dòng trên Mobile, Khóa lại (nowrap) trên Desktop */}
              ...
              <div className="flex items-start gap-2">
                ...
                {/* Email dài sẽ được break-all trên Mobile, Desktop giữ bình thường */}
                <span className="break-all whitespace-normal md:break-normal md:whitespace-nowrap">
                  nsgroup@gmail.com
                </span>
              </div>
