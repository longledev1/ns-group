      ...
      <div className="mx-auto">
        ...
        <div className="mb-10 grid grid-cols-1 items-center gap-6 md:grid-cols-12">
          ...
          <div className="h-[400px] md:col-span-2">
            <img
              loading="lazy"
              src="/images/fnb/kingclam/kingClam_space1.webp"
              alt="Inspiration 1"
          ...
          <div className="h-[400px] md:col-span-2">
            <img
              loading="lazy"
              src="/images/fnb/kingclam/kingClam_space2.webp"
              alt="Inspiration 2"
              className="h-full w-full object-cover"
            />
          </div>
          ...
          <div className="h-[400px] md:col-span-5">
            <img
              loading="lazy"
              src="/images/fnb/kingclam/kingClam_space3.webp"
              alt="Inspiration 3"
              className="h-full w-full object-cover"
            />
          </div>
        ...
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-12">
          ...
          <div className="h-[500px] md:col-span-7">
            <img
              loading="lazy"
              src="/images/fnb/kingclam/kingClam_space4.webp"
          ...
          <div className="mt-[-140px] px-4 md:col-span-5">
            <p className="font-montserrat text-sm leading-relaxed md:text-base">
