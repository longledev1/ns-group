      ...
      <div className="">
        ...
        <div className="mb-10 grid grid-cols-1 items-center gap-10 md:grid-cols-2 lg:gap-16">
          ...
          <div className="h-[350px] w-full overflow-hidden">
            <img
              loading="lazy"
              src="/images/fnb/kingclam/grill4.webp"
              alt="Kitchen Fire"
          ...
          <div className="px-4 text-center md:text-left lg:px-10">
            ...
            <p className="font-montserrat text-justify text-sm leading-relaxed md:text-base">
        ...
        <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-12 lg:gap-10">
          ...
          <div className="grid h-[450px] grid-cols-2 gap-6 md:col-span-5">
            <div className="h-full overflow-hidden">
              <img
                loading="lazy"
                src="/images/fnb/kingclam/grill1.avif"
                alt="Chef at work"
                className="h-full w-full object-cover"
              />
            </div>
            <div className="h-full overflow-hidden">
              <img
                loading="lazy"
                src="/images/fnb/kingclam/grill2.avif"
                alt="Bar counter"
                className="h-full w-full object-cover"
              />
            </div>
