...
const seasonsData = [
  ...
  },
  {
    ...
    img: "/images/yenbay_retreat_bg.png",
  },
];
  ...
  return (
    <div className="w-full  overflow-hidden">
      ...
      <Swiper
        ...
        className="w-full [&_.swiper-slide]:opacity-40 [&_.swiper-slide]:transition-opacity [&_.swiper-slide]:duration-500 md:[&_.swiper-slide-active]:!opacity-100 md:[&_.swiper-slide-next]:!opacity-100 max-md:[&_.swiper-slide-active]:!opacity-100"
      >
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="mt-6 pr-4">
                <p className="font-montserrat text-sm uppercase tracking-wide text-gray-500">
                  {item.time}
                </p>
