export const StoryNSG = () => {
  return (
    <div className="border-CTA font-montserrat relative top-[-80px] w-full border">
      <div className="mt-30 p-10 leading-[32px]">
        <div className="mb-6 flex flex-col">
          <h2 className="font-heading mb-6 text-4xl font-semibold">
            CÂU CHUYỆN BẮT ĐẦU
          </h2>
          <div className="mt-[-20px] h-px w-40 bg-gradient-to-r from-transparent via-[#C6A75E] to-transparent"></div>
        </div>
