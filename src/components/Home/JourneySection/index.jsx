...
export const JourneySection = () => {
  ...
  return (
    <section>
      ...
      <div className="mt-10">
        {/* Top content - Đã thêm flex-col cho mobile và lg:flex-row cho desktop */}
        <div className="mb-6 flex flex-col justify-between gap-y-10 lg:flex-row lg:items-center lg:gap-x-20">
          {/* Cột Text - Giới hạn width trên desktop để không lấn át ảnh */}
          <div className="text-primary font-montserrat w-full text-justify text-[14px] leading-[30px] font-light md:text-[15px] lg:w-1/2">
            <p>
              <span className="font-bold">Ngọc Sương Group (NSG)</span> được
              sáng lập bởi ông Trần Anh Dũng, người có hơn 40 năm kinh nghiệm
              trong lĩnh vực F&B tại Việt Nam và quốc tế. Ông là con trai của
              ông Trần Tương – người đặt nền móng cho thương hiệu Ngọc Sương từ
              năm <span className="text-CTA font-bold">1955</span>.
            </p>
            <p className="mt-4">
          ...
          <div className="w-full lg:w-1/2">
            ...
            />
            <p className="mt-2 text-center text-sm text-gray-600 italic lg:text-base">
              Ảnh chụp ông Trần Tương (trái) và ông Trần Anh Dũng tại Trại Mát
            </p>
          </div>
        </div>

        {/* Grid gallery - Mobile 2 cột, Tablet 2-3 cột, Desktop 4 cột */}
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4 lg:gap-x-6 lg:gap-y-6">
          {images.slice(1).map((img, idx) => {
            ...
            return (
              <img
                ...
                src={img.src}
                alt=""
                className="h-32 w-full cursor-zoom-in object-cover transition-transform duration-300 hover:scale-105 md:h-40 lg:h-55"
